...
export default function Home() {
  return (
    <div className="container min-w-full">
      ...
      >
        <div className="h-screen bg-opacity-10 bg-black flex items-center justify-center">
      ...
      <section className="text-white bg-blue-900 p-20 h-full">
      ...
      <div className="bg-center bg-fixed bg-no-repeat bg-cover relative bg-banner">
        ...
        <div className="container mx-auto px-6 sm:px-12 lg:py-6 xl:py-16 relative flex flex-col sm:flex-row">
          <div className="sm:w-1/2 sm:pt-8 lg:pt-16 pb-8 sm:pb-16 lg:pb-32 relative z-30">
              <h2 className="uppercase text-orange-500 font-bold tracking-wider text-2xl">Promoción Especial en</h2>
              <h1 className="uppercase font-black text-white leading-none tracking-wider mb-6 mt-4 text-5xl lg:text-6xl xl:text-7xl ">Productos de Limpieza </h1>
              <p className="text-grey-800 font-roboto text-lg sm:w-2/3 lg:w-1/2">Lorem ipsum dolor sit amet, consec tetur adipiscing elit, sed do eiusmod tempor incid idunt ut labore dolore.</p>
          </div>
          <div className="sm:w-1/2 lg:w-2/3 relative sm:absolute bottom-0 right-0 ">
              
              <img className="absolute left-0 right-0 w-full h-full object-contain bg-center z-10 bg-no-repeat" src="/hero/banner.jpg" />
              <div className="bg-blue-900 absolute inset-0 mt-16 -ml-8"></div>
              <svg className="relative z-20 pt-8 -ml-0" xmlns="http://www.w3.org/2000/svg" data-name="Capa 1" viewBox="0 0 428.29 298.11"><defs/>
              ...
              <path fill="#f16722" d="M1.75 126A1.75 1.75 0 110 127.77 1.75 1.75 0 011.75 126zM1.75 116.65A1.76 1.76 0 110 118.41a1.75 1.75 0 011.75-1.76zM10.78 294.6A1.76 1.76 0 119 296.36a1.76 1.76 0 011.78-1.76zM10.78 285.24A1.75 1.75 0 119 287a1.75 1.75 0 011.78-1.76zM10.78 275.87A1.76 1.76 0 119 277.62a1.76 1.76 0 011.78-1.75zM10.78 266.51A1.75 1.75 0 119 268.26a1.75 1.75 0 011.78-1.75zM10.78 257.14A1.75 1.75 0 119 258.89a1.75 1.75 0 011.78-1.75zM10.78 247.77A1.76 1.76 0 119 249.53a1.76 1.76 0 011.78-1.76zM10.78 238.41A1.75 1.75 0 119 240.16a1.75 1.75 0 011.78-1.75zM10.78 229A1.76 1.76 0 119 230.8a1.76 1.76 0 011.78-1.8zM10.78 219.68A1.75 1.75 0 119 221.43a1.75 1.75 0 011.78-1.75zM10.78 210.31A1.76 1.76 0 119 212.06a1.76 1.76 0 011.78-1.75zM10.78 201A1.75 1.75 0 119 202.7a1.75 1.75 0 011.78-1.7zM10.78 191.58A1.75 1.75 0 119 193.33a1.75 1.75 0 011.78-1.75zM10.78 182.21A1.76 1.76 0 119 184a1.76 1.76 0 011.78-1.79zM10.78 172.85A1.75 1.75 0 119 174.6a1.75 1.75 0 011.78-1.75zM10.78 163.48A1.76 1.76 0 119 165.23a1.76 1.76 0 011.78-1.75zM10.78 154.12A1.75 1.75 0 119 155.87a1.75 1.75 0 011.78-1.75zM10.78 144.75A1.75 1.75 0 119 146.5a1.76 1.76 0 011.78-1.75zM10.78 135.39A1.75 1.75 0 119 137.14a1.75 1.75 0 011.78-1.75zM10.78 126A1.75 1.75 0 119 127.77a1.75 1.75 0 011.78-1.77zM10.78 116.65A1.76 1.76 0 119 118.41a1.76 1.76 0 011.78-1.76z"/><circle cx="19.82" cy="296.36" r="1.75" fill="#f16722"/><circle cx="19.82" cy="286.99" r="1.75" fill="#f16722"/><circle cx="19.82" cy="277.62" r="1.75" fill="#f16722"/><circle cx="19.82" cy="268.26" r="1.75" fill="#f16722"/><circle cx="19.82" cy="258.89" r="1.75" fill="#f16722"/><circle cx="19.82" cy="249.53" r="1.75" fill="#f16722"/><circle cx="19.82" cy="240.16" r="1.75" fill="#f16722"/><circle cx="19.82" cy="230.8" r="1.75" fill="#f16722"/><circle cx="19.82" cy="221.43" r="1.75" fill="#f16722"/><circle cx="19.82" cy="212.06" r="1.75" fill="#f16722"/><circle cx="19.82" cy="202.7" r="1.75" fill="#f16722"/>
              ...
              <path fill="#f16722" d="M19.82 126a1.75 1.75 0 11-1.75 1.75 1.75 1.75 0 011.75-1.75zM19.82 116.65a1.76 1.76 0 11-1.75 1.76 1.75 1.75 0 011.75-1.76z"/>
      ...
      <div className="w-full bg-blue-900 flex flex-wrap p-20 self-center mx-auto items-center justify-center">
        <div className="p-5 m-10  lg:w-1/3 xl:w-1/3 w-100 items-stretch rounded-lg bg-white shadow-lg text-gray-800">
